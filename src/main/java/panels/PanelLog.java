...
public class PanelLog extends GridPanel {
    ...
    public static int getColor(RecordType recordType) {
        return switch (recordType) {
            case INFO -> Misc.getColor(1000, 0, 0, 0);
            case WARNING -> Misc.getColor(1000, 0, 100, 100);
            case ERROR -> Misc.getColor(1000, 255, 0, 0);
            case SUCCESS -> Misc.getColor(1000, 0, 255, 0);
        };
    }
    /**
     * Обработчик событий
